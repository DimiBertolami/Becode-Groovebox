var Tonal = function () {
    ...
    const o = [0, 2, 4, -1, 1, 3, 5], a = o.map((e => Math.floor(7 * e / 12)));

    function m(e) {
        const {step: n, alt: t, oct: r, dir: m = 1} = e, i = o[n] + 7 * t;
    ...
    function c(e) {
        ...
        if (void 0 === t) return {step: o, alt: m, dir: r};
        return {step: o, alt: m, oct: t + 4 * m + a[o], dir: r}
    }

    const s = {empty: !0, name: "", pc: "", acc: ""}, u = new Map, l = e => "CDEFGAB".charAt(e),
        d = n => n < 0 ? e("b", -n) : e("#", n), P = e => "b" === e[0] ? -e.length : e.length;
    ...
    function M(e) {
        ...
        const o = "string" == typeof e ? function (e) {
            const n = p(e);
            if ("" === n[0] || "" !== n[3]) return s;
            const t = n[0], r = n[1], o = n[2], a = (t.charCodeAt(0) + 3) % 7, i = P(r), c = o.length ? +o : void 0,
                u = m({step: a, alt: i, oct: c}), l = t + r + o, d = t + r, M = (y[a] + i + 120) % 12,
                f = void 0 === c ? (g = y[a] + i, A = 12, (g % A + A) % A - 1188) : y[a] + i + 12 * (c + 1),
                h = f >= 0 && f <= 127 ? f : null, b = void 0 === c ? null : 440 * Math.pow(2, (f - 69) / 12);
            var g, A;
            return {
                empty: !1,
                acc: r,
            ...
            const {step: n, alt: t, oct: r} = e, o = l(n);
            if (!o) return "";
            const a = o + d(t);
            return r || 0 === r ? a + r : a
        }(e)) : t(e) ? M(e.name) : s;
    ...
    function j(n) {
        return "string" == typeof n ? v[n] || (v[n] = function (e) {
            const n = A(e);
            if ("" === n[0]) return b;
            const t = +n[0], r = n[1], o = (Math.abs(t) - 1) % 7, a = N[o];
            if ("M" === a && "P" === r) return b;
            const i = "M" === a ? "majorable" : "perfectable", c = "" + t + r, s = t < 0 ? -1 : 1,
                u = 8 === t || -8 === t ? t : s * (o + 1), l = function (e, n) {
                ...
                }(i, r), d = Math.floor((Math.abs(t) - 1) / 7), P = s * (I[o] + l + 12 * d),
                M = (s * (I[o] + l) % 12 + 12) % 12, f = m({step: o, alt: l, oct: d, dir: s});
            return {
                empty: !1,
                name: c,
                num: t,
    ...
    const I = [0, 2, 4, 5, 7, 9, 11], N = "PMMPPMM";
    ...
    function T(e, n) {
        const t = M(e), r = M(n);
        if (t.empty || r.empty) return "";
        const o = t.coord, a = r.coord, m = a[0] - o[0];
    ...
    const D = (e, n) => Array(n + 1).join(e), S = /^(_{1,}|=|\^{1,}|)([abcdefgABCDEFG])([,']*)$/;
    ...
    var q = {
        abcToScientificNotation: V, scientificToAbcNotation: $, tokenize: C, transpose: function (e, n) {
            return $(x(V(e), n))
    ...
    var E = Object.freeze({
        __proto__: null, compact: function (e) {
    ...
    var R = {
        compact: z, permutations: function e(n) {
            return 0 === n.length ? [[]] : e(n.slice(1)).reduce(((e, t) => e.concat(n.map(((e, r) => {
                const o = t.slice();
                return o.splice(r, 0, n[0]), o
            })))), [])
        }, range: _, rotate: F, shuffle: function (e, n = Math.random) {
            let t, r, o = e.length;
            for (; o;) t = Math.floor(n() * o--), r = e[o], e[o] = e[t], e[t] = r;
            return e
        }
    };
    const U = {empty: !0, name: "", setNum: 0, chroma: "000000000000", normalized: "000000000000", intervals: []},
        B = e => Number(e).toString(2), G = e => parseInt(e, 2), K = /^[01]{12}$/;
    ...
    function J(e) {
        ...
        return H[n] = H[n] || function (e) {
            const n = G(e), t = function (e) {
                const n = e.split("");
                return n.map(((e, t) => F(t, n).join("")))
            }(e).map(G).filter((e => e >= 2048)).sort()[0], r = B(t), o = function (e) {
                const n = [];
                for (let t = 0; t < 12; t++) "1" === e.charAt(t) && n.push(W[t]);
                return n
            }(e);
            return {empty: !1, name: "", setNum: n, chroma: e, normalized: r, intervals: o}
        }(n)
    }
    ...
    const te = {...U, name: "", quality: "Unknown", intervals: [], aliases: []};
    let re = [], oe = {};
    ...
    function be(e, n, t = []) {
        const r = {...J(e), name: n, intervals: e, aliases: t};
    ...
    var ge = {
        names: Me, get: fe, all: he, add: be, removeAll: function () {
            de = [], Pe = {}
        }, keys: function () {
            return Object.keys(Pe)
        }, entries: ye, scaleType: pe
    };
    const Ae = {
        empty: !0,
        name: "",
    ...
    function Ne(e, n, t) {
        const r = ae(e), o = M(n || ""), a = M(t || "");
        if (r.empty || n && o.empty || t && a.empty) return Ae;
        const m = T(o.pc, a.pc), i = r.intervals.indexOf(m) + 1;
        if (!a.empty && !i) return Ae;
        const c = Array.from(r.intervals);
        for (let e = 1; e < i; e++) {
            const e = c[0][0], n = c[0][1], t = parseInt(e, 10) + 7;
            c.push(`${t}${n}`), c.shift()
        }
    ...
    var Oe = {
        getChord: Ne, get: Ie, detect: function (e) {
            const n = e.map((e => M(e).pc)).filter((e => e));
            return 0 === M.length ? [] : function (e, n) {
                const t = e[0], r = M(t).chroma, o = (e => {
                ...
                return a.forEach(((e, a) => {
                    ie().filter((n => n.chroma === e)).forEach((e => {
                        const i = e.aliases[0], c = o(a);
                        a !== r ? m.push({weight: .5 * n, name: `${c}${i}/${t}`}) : m.push({
                            weight: 1 * n,
                            name: `${c}${i}`
                        })
                    }))
            ...
            const n = Ie(e), t = Z(n.chroma);
            return ie().filter((e => t(e.chroma))).map((e => n.tonic + e.aliases[0]))
        }, reduced: function (e) {
            const n = Ie(e), t = Y(n.chroma);
            return ie().filter((e => t(e.chroma))).map((e => n.tonic + e.aliases[0]))
        }, tokenize: je, transpose: function (e, n) {
            const [t, r] = je(e);
            return t ? x(t, n) + r : e
    ...
    const Te = {empty: !0, name: "", value: 0, fraction: [0, 0], shorthand: "", dots: "", names: []};
    const we = /^([^.]+)(\.*)$/;
    ...
    function De(e) {
        ...
        const a = function (e, n) {
            ...
            return [r, o]
        }(o.fraction, r.length), m = a[0] / a[1];
        return {...o, name: e, dots: r, value: m, fraction: a}
    }
    ...
    var Se = {
        ...
        }, get: De, value: e => De(e).value, fraction: e => De(e).fraction
    };
    const Ce = j;
    ...
    const $e = [1, 2, 2, 3, 3, 4, 5, 5, 6, 6, 7, 7], qe = "P m M m M P d P m M m M".split(" ");
    const ke = T, Ee = Re(((e, n) => [e[0] + n[0], e[1] + n[1]])), _e = Re(((e, n) => [e[0] - n[0], e[1] - n[1]]));
    ...
    var ze = {
        ...
        fromSemitones: function (e) {
            const n = e < 0 ? -1 : 1, t = Math.abs(e), r = t % 12, o = Math.floor(t / 12);
    ...
    const Ge = Math.log(2), Ke = Math.log(440);
    ...
    const He = "C C# D D# E F F# G G# A A# B".split(" "), Je = "C Db D Eb E F Gb G Ab A Bb B".split(" ");
    ...
    var We = {
        isMidi: Ue, toMidi: Be, midiToFreq: function (e, n = 440) {
            return Math.pow(2, (e - 69) / 12) * n
        }, midiToNoteName: Qe, freqToMidi: Le
    };
    const Xe = ["C", "D", "E", "F", "G", "A", "B"], Ye = e => e.name, Ze = e => e.map(M).filter((e => !e.empty));
    const en = M;
    ...
    const tn = x, rn = e => n => tn(n, e), on = e => n => tn(e, n);
    ...
    function un(e, n) {
        const t = en(e);
        if (t.empty) return "";
        const r = en(n || Qe(t.midi || t.chroma, {sharps: t.alt < 0, pitchClass: !0}));
        if (r.empty || r.chroma !== t.chroma) return "";
        if (void 0 === t.oct) return r.pc;
        const o = t.chroma - t.alt, a = r.chroma - r.alt, m = o > 11 || a < 0 ? -1 : o < 0 || a > 11 ? 1 : 0,
            i = t.oct + m;
        return r.pc + i
    }
    ...
    var ln = {
        ...
        simplify: e => {
            const n = en(e);
            return n.empty ? "" : Qe(n.midi || n.chroma, {sharps: n.alt > 0, pitchClass: null === n.midi})
        },
        enharmonic: un
    };
    const dn = {empty: !0, name: "", chordType: ""}, Pn = {};
    ...
    function Mn(e) {
        return "string" == typeof e ? Pn[e] || (Pn[e] = function (e) {
            ...
            var a;
            if (!r) return dn;
            const m = r.toUpperCase(), i = yn.indexOf(m), c = P(t), s = 1;
            return {
                empty: !1,
                name: n,
                roman: r,
                interval: j({step: i, alt: c, dir: s}).name,
                acc: t,
                chordType: o,
                alt: c,
                step: i,
    ...
    const hn = "I II III IV V VI VII", yn = hn.split(" "), bn = hn.toLowerCase().split(" ");
    var gn = {
        names: function (e = !0) {
            return (e ? yn : bn).slice()
        }, get: Mn, romanNumeral: fn
    };
    const An = Object.freeze([]), vn = {type: "major", tonic: "", alteration: 0, keySignature: ""},
        jn = {tonic: "", grades: An, intervals: An, scale: An, chords: An, chordsHarmonicFunction: An, chordScales: An},
        In = {
            ...vn, ...jn,
            type: "major",
            minorRelative: "",
        ...
        }, Nn = {...vn, type: "minor", relativeMajor: "", natural: jn, harmonic: jn, melodic: jn},
        On = (e, n, t = "") => n.map(((n, r) => `${e[r]}${t}${n}`));

    function xn(e, n, t, r) {
        return o => {
            const a = e.map((e => Mn(e).interval || "")), m = a.map((e => x(o, e)));
            return {
                tonic: o,
                grades: e,
                intervals: a,
    ...
    const $n = [[0, 2773, 0, "ionian", "", "Maj7", "major"], [1, 2902, 2, "dorian", "m", "m7"], [2, 3418, 4, "phrygian", "m", "m7"], [3, 2741, -1, "lydian", "", "Maj7"], [4, 2774, 1, "mixolydian", "", "7"], [5, 2906, 3, "aeolian", "m", "m7", "minor"], [6, 3434, 5, "locrian", "dim", "m7b5"]],
        qn = {...U, name: "", alt: 0, modeNum: NaN, triad: "", seventh: "", aliases: []}, kn = $n.map((function (e) {
    ...
    function Un(e) {
        return (n, t) => {
            const r = _n(n);
            if (r.empty) return [];
            const o = F(r.modeNum, e), a = r.intervals.map((e => x(t, e)));
    ...
    var Gn = {
        get: _n, names: function () {
            return kn.map((e => e.name))
        }, all: zn, distance: Bn, relativeTonic: function (e, n, t) {
            return x(t, Bn(e, n))
        }, notes: function (e, n) {
            return _n(e).intervals.map((e => x(n, e)))
        }, triads: Un($n.map((e => e[4]))), seventhChords: Un($n.map((e => e[5]))), entries: Rn, mode: Fn
    };
    var Kn = {
    ...
    var Hn = {
        numeric: Ln, chromatic: function (e, n) {
    ...
    function Qn(e) {
        ...
        const n = e.indexOf(" "), t = M(e.substring(0, n));
        if (t.empty) {
            const n = M(e);
    ...
    function Wn(e) {
        const n = Array.isArray(e) ? e : Qn(e), t = M(n[0]).name, r = fe(n[1]);
        if (r.empty) return Jn;
        const o = r.name, a = t ? r.intervals.map((e => x(t, e))) : [], m = t ? t + " " + o : o;
        return {...r, name: m, type: o, tonic: t, notes: a}
    }

    function Xn(e) {
        const n = e.map((e => M(e).pc)).filter((e => e)), t = n[0], r = sn(n);
        return F(r.indexOf(t), r)
    }

    var Yn = {
        get: Wn, names: Me, extended: function (e) {
        ...
        }, scaleNotes: Xn, tokenize: Qn, rangeOf: function (e) {
            const n = function (e) {
                const n = Array.isArray(e) ? Xn(e) : Wn(e).notes, t = n.map((e => M(e).chroma));
                return e => {
                    const r = M("number" == typeof e ? nn(e) : e), o = r.height;
                    if (void 0 === o) return;
                    const a = o % 12, m = t.indexOf(a);
                    return -1 !== m ? un(r.name, n[m]) : void 0
                }
            }(e);
            return (e, t) => {
                const r = M(e).height, o = M(t).height;
                return void 0 === r || void 0 === o ? [] : _(r, o).map(n).filter((e => e))
            }
        }, scale: n("Scale.scale", "Scale.get", Wn)
    };
    const Zn = {empty: !0, name: "", upper: void 0, lower: void 0, type: void 0, additive: []},
        et = ["4/4", "3/4", "2/4", "2/2", "12/8", "9/8", "6/8", "3/8"];
    const nt = /^(\d?\d(?:\+\d)*)\/(\d)$/, tt = new Map;
    ...
    var ot = {
        names: function () {
            return et.slice()
        }, parse: rt, get: function (e) {
            const n = tt.get(e);
            if (n) return n;
            const t = function ([e, n]) {
                const t = Array.isArray(e) ? e.reduce(((e, n) => e + n), 0) : e, r = n;
                if (0 === t || 0 === r) return Zn;
                const o = Array.isArray(e) ? `${e.join("+")}/${n}` : `${e}/${n}`, a = Array.isArray(e) ? e : [];
                return {
                    empty: !1,
                    name: o,
    ...
    var at, mt, it = (function (e, n) {
        !function (e, n, t, r, o, a, m, i, c, s, u, l, d, P, M, f, p, h, y, b) {
            ...
            var v = g(n), j = A(t), I = g(r), N = g(o), O = g(a), x = A(m), T = g(i), w = g(c), D = g(s), S = g(u),
                C = g(l), V = g(d), $ = g(P), q = g(M), k = g(f), E = g(p), _ = g(h), F = g(y), z = g(b), R = x,
                U = $.default, B = N.default, G = F.default;
    ...
    }(at = {exports: {}}, at.exports), at.exports);
